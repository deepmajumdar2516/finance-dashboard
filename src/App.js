...
const NetWorthChart = ({ transactions, theme }) => {
  ...
  useEffect(() => {
    ...
    // FIX: Clear existing chart first, even if data is empty
...
export default function App() {
  const [transactions, setTransactions, undo, redo, clearAll, historyMeta] =
    useHistoryState(INITIAL_DATA, "finance_v13_data");
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <button
            ...
            style={{
              ...actionBtn(theme),
              opacity: historyMeta.canUndo ? 1 : 0.5,
            }}
          >
            <Undo size={16} />
          </button>
          <button
            ...
            style={{
              ...actionBtn(theme),
              opacity: historyMeta.canRedo ? 1 : 0.5,
            }}
          >
            <Redo size={16} />
          </button>
          ...
          <label style={{ ...actionBtn(theme), cursor: "pointer" }}>
            <Upload size={16} />{" "}
            <input
              type="file"
              style={{ display: "none" }}
      ...
      >
        ...
        <div key="input" style={cardStyle(theme)}>
          ...
          <TransactionForm
            onAdd={(t) => setTransactions((prev) => [...prev, t])}
